...
| Buyer | Home / Landing   | B-HOME-03    | Define editorial rules for featured products and shops           | Clear rules exist for what can appear in “featured” (ethics, diversity, recency, etc.)   | Next     | done   |
| Buyer | Home / Landing   | B-HOME-04    | Define buyer CTAs (buy vs. sell) and their placement             | Primary and secondary CTAs and entry points to seller onboarding are decided             | Now      | done   |
